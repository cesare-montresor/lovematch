...
//        echo '</pre>';
    ...
    {   
        ...
        $compare = [
            ...
            ['moon','asc',5,'other'], //can help to develop intuition, female moon though, help him to rise into personql evolution
            ['asc','moon',5,'other'], // so call it personal evolution
            
            ['moon','sun',5,'love'], 
            ['venus','mars',5,'sex'], 
            ['mars','venus',5,'sex'] //total 87
            // indi planet on midheaven is helping his career
            // for spirituality jupiter an midheaven and north node with ind planet mostly conjunction
        ];
